...
void init_cycfg_pins(void)
{
	...
	XMC_GPIO_SetHardwareControl(CYBSP_USER_BTN2_PORT, CYBSP_USER_BTN2_PIN, CYBSP_USER_BTN2_HWCTRL);

	XMC_GPIO_Init(CYBSP_USER_BTN_PORT, CYBSP_USER_BTN_PIN, &CYBSP_USER_BTN_config);
	XMC_GPIO_SetHardwareControl(CYBSP_USER_BTN_PORT, CYBSP_USER_BTN_PIN, CYBSP_USER_BTN_HWCTRL);
